...
HOST = 'https://gocchandesu.documents.azure.com:443/'
MASTER_KEY = 'czrxPWirXZ2TN6SClVRypPsyC4BdBdtKii5Ytv9T5s23Jf4aaDOzUzHBue7fxZwgFJyWR9tXVYfdPhZ2PflwwQ=='
...
def create_items(container):
    ...
    sales_order2 = get_sales_order_v2("SalesOrder1")
